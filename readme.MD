...
- To prevent the Google Sheets document from becomming too large you should periodically archive data to another worksheet and delete data from the master document.
